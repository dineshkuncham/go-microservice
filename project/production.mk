...
build_auth:
	...
	cd ../authentication-service && env GOOS=linux CGO_ENABLED=0 GOARCH=amd64 go build -o ${AUTH_BINARY} ./cmd/api
	@echo "Done!"
...
build_mailer:
	...
	cd ../mail-service && env GOOS=linux CGO_ENABLED=0 GOARCH=amd64 go build -o ${MAILER_BINARY} ./cmd/api
	@echo "Done!"
...
build_front:
	...
	cd ../front-end && env CGO_ENABLED=0 GOARCH=amd64 go build -o ${FRONT_BINARY} ./cmd/web
	@echo "Done!"

## start: starts the front end
start: build_front
	@echo "Starting front end"
	cd ../front-end && ./${FRONT_BINARY} &
